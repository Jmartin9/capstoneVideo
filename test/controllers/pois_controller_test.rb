...
class PoisControllerTest < ActionController::TestCase
  ...
  test "should create poi" do
    assert_difference('Poi.count') do
      post :create, poi: { address: @poi.address, description: @poi.description, name: @poi.name, picture: @poi.picture }
    end
  ...
  test "should update poi" do
    patch :update, id: @poi, poi: { address: @poi.address, description: @poi.description, name: @poi.name, picture: @poi.picture }
    assert_redirected_to poi_path(assigns(:poi))
  end
